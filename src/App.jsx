        ...
        list: [
          {
            ...
            imageFit: "contain"   // Image entière
          },
          {
          ...
          },
          {
            ...
            color: "teal",
            layout: "horizontal", // Horizontal aussi pour celui-ci
            imageFit: "contain"   // Image entière
          },
          {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-8">
            {t.projects.list.map((project, index) => {
               ...
               // Tous les projets sont maintenant horizontaux
               ...
               return (
                <div key={index} className={`bg-slate-950 rounded-xl overflow-hidden border border-slate-800 transition-all duration-300 hover:shadow-2xl ${style.border} flex flex-col ${isHorizontal ? 'md:flex-row' : ''}`}>
                  ...
                  {/* Zone Image : Ajustée à w-1/3 pour "rétrécir" la zone */}
                  <div className={`${isHorizontal ? 'md:w-1/3 h-64 md:h-auto' : 'h-48'} bg-slate-900 relative overflow-hidden group border-b md:border-b-0 md:border-r border-slate-800`}>
                     <img 
                       src={project.image} 
                       alt={project.title} 
                  ...
                  {/* Zone Contenu : Prend maintenant 2/3 de la largeur (plus de place) */}
                  <div className={`p-6 flex flex-col flex-grow ${isHorizontal ? 'md:w-2/3' : ''}`}>
